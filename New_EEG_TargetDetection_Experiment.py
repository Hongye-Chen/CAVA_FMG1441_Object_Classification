...
expName = 'New_EEG_TargetDetection_Experiment'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\Users\\Niklas\\eeg_experiment-main\\New_EEG_TargetDetection_Experiment.py',
...
ioServer = io.launchHubServer(window=win, experiment_code='New_EEG_TargetDetection_Experiment', session_code=ioSession, datastore_name=filename, **ioConfig)
