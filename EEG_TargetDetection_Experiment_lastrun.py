...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\15202\\OneDrive\\C_\\University of Amsterdam\\Intern\\EEG_TargetDetection_Experiment_lastrun.py',
...
for thisRepetition in Repetition:
    ...
    for thisBlock in Blocks:
        ...
        for thisTrial in Trials:
            ...
            _key_resp_allKeys = []
            # keep track of which components have finished
            ResponseComponents = [blank_screen_last, corss_last, text, key_resp]
